...
const styles = StyleSheet.create({
  ...
  chipActive: { backgroundColor: palette.accentSoft },
  ...
  messageCard: { gap: 12 },
  unreadCard: { borderColor: palette.accent },
  ...
  unreadPill: { backgroundColor: palette.accentSoft, color: palette.text },
  readPill: { backgroundColor: palette.softPanelStrong, color: palette.subtleText },
});
